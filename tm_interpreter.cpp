...
static void print_usage(string error) {
    cerr << "ERROR: " << error << "\n"
         << "Usage: tm_interpreter [-q|--quiet] [-ot|--use-original] <input_file> <input>\n";
    exit(1);
}
...
void run(const TuringMachine &tm, string input)
{
